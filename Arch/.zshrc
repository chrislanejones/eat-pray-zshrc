...
#
# 1. System Tools:
#    sudo pacman -S zoxide eza bat fzf direnv curl git
#
...
# 6. Go: sudo pacman -S go
# 7. Zig: sudo pacman -S zig (or extract to ~/zig-linux-x86_64-0.13.0)
# ==============================================================================
...
pullscript() {
  ...
  local selected_file=$(ls "$SCRIPT_DIR" | fzf \
    ...
    --height=40% \
    --reverse \
    --preview "bat --color=always --style=numbers $SCRIPT_DIR/{}")
