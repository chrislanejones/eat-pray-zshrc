# ================================================
# ~/.zshrc — Fedora Edition
# ================================================

# 0. Only run in interactive zsh shells
[[ -z "$ZSH_VERSION" ]] && return

# >>> managed by chatgpt (Fedora zig & xrun) >>>
# Fedora-friendly PATH setup (no duplicates). Includes common script locations
...
# 11. Go language (Fedora)
export PATH="/usr/lib/golang/bin:$HOME/go/bin:$PATH"
...
# 13. Zig (system Zig or home-installed)
# Fedora provides zig in /usr/bin/zig
# Home zig installs are already handled at the top
